...
base_rewrite = PatternMatcher([
  ...
  (UPat(Ops.DEFINE_MEM, name="x"), lambda ctx,x: f"{ctx.smem_align}{ctx.smem_prefix}{ctx.render_dtype(x.dtype.base)} {ctx[x]}[{x.dtype.size}];" if not x.dtype.local else None),
