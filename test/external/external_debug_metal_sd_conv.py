...
ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
  UOp(Ops.STORE, dtypes.void, arg=None, src=(
    UOp(Ops.DEFINE_MEM, dtypes.half.ptr(), arg=0, src=()),
    ...
    UOp(Ops.ADD, dtypes.half, arg=None, src=(
      UOp(Ops.ADD, dtypes.half, arg=None, src=(
            ...
            UOp(Ops.CAST, dtypes.float, arg=None, src=(
              UOp(Ops.MUL, dtypes.half, arg=None, src=(
                UOp(Ops.LOAD, dtypes.half, arg=None, src=(
                  UOp(Ops.DEFINE_MEM, dtypes.half.ptr(), arg=1, src=()),
                ...
                UOp(Ops.LOAD, dtypes.half, arg=None, src=(
                  UOp(Ops.DEFINE_MEM, dtypes.half.ptr(), arg=2, src=()),
        ...
        UOp(Ops.LOAD, dtypes.half, arg=None, src=(
          UOp(Ops.DEFINE_MEM, dtypes.half.ptr(), arg=3, src=()),
      ...
      UOp(Ops.LOAD, dtypes.half, arg=None, src=(
        UOp(Ops.DEFINE_MEM, dtypes.half.ptr(), arg=4, src=()),
         x17,)),)),)),))
