...
class TestOpenpilotValidhack(unittest.TestCase):
  def test_valid_removal(self):
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        UOp(Ops.DEFINE_MEM, dtypes.imagef((64, 1024, 4)), arg=0, src=()),
        ...
        UOp(Ops.ADD, dtypes.float, arg=None, src=(
          UOp(Ops.MAX, dtypes.float, arg=None, src=(
            x5:=UOp(Ops.ADD, dtypes.float, arg=None, src=(
                ...
                UOp(Ops.CAST, dtypes.float, arg=None, src=(
                  UOp(Ops.MUL, dtypes.float, arg=None, src=(
                    UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                      UOp(Ops.DEFINE_MEM, dtypes.imagef((128, 768, 4)), arg=1, src=()),
                    ...
                    UOp(Ops.CAST, dtypes.float, arg=None, src=(
                      UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                        UOp(Ops.DEFINE_MEM, dtypes.imagef((8, 108, 4)), arg=2, src=()),
              ...
              UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                UOp(Ops.DEFINE_MEM, dtypes.float.ptr(), arg=3, src=()),
  ...
  def test_const_idx(self):
    ...
    ast = UOp(Ops.SINK, dtypes.void, arg=None, src=(
      UOp(Ops.STORE, dtypes.void, arg=None, src=(
        UOp(Ops.DEFINE_MEM, dtypes.imagef((10, 128, 4)), arg=0, src=()),
        ...
        UOp(Ops.CAST, dtypes.float, arg=None, src=(
          UOp(Ops.ADD, dtypes.float, arg=None, src=(
            UOp(Ops.ADD, dtypes.float, arg=None, src=(
              UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                UOp(Ops.DEFINE_MEM, dtypes.imagef((1, 128, 4)), arg=1, src=()),
                      ...
                      UOp(Ops.ADD, dtypes.float, arg=None, src=(
                        UOp(Ops.ADD, dtypes.float, arg=None, src=(
                          UOp(Ops.ADD, dtypes.float, arg=None, src=(
                            UOp(Ops.ADD, dtypes.float, arg=None, src=(
                              UOp(Ops.LOAD, dtypes.float, arg=None, src=(
                                x18:=UOp(Ops.DEFINE_MEM, dtypes.float.ptr(), arg=2, src=()),
            ...
            UOp(Ops.LOAD, dtypes.float, arg=None, src=(
              UOp(Ops.DEFINE_MEM, dtypes.imagef((1, 128, 4)), arg=3, src=()),
